...
Blockly.Blocks.motionStaticToolbox = '<xml id="toolbox-categories" style="display: none">' +
...
Blockly.Blocks.motionMobileToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_MOTION}" id="motion" colour="#4C97FF" secondaryColour="#3373CC">' +
...
Blockly.Blocks.motionToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_MOTION}" id="motion" colour="#4C97FF" secondaryColour="#3373CC">' +
'</category>';

Blockly.Blocks.looksGraphicsToolbox = '<xml id="toolbox-categories" style="display: none">' +
...
Blockly.Blocks.looksUtilityToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_LOOKS}" id="looks" colour="#9966FF" secondaryColour="#774DCB">' +
...
Blockly.Blocks.looksToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_LOOKS}" id="looks" colour="#9966FF" secondaryColour="#774DCB">' +
'</category>';

Blockly.Blocks.soundOptionsToolbox = '<xml id="toolbox-categories" style="display: none">' +
...
Blockly.Blocks.soundVocalToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_SOUND}" id="sound" colour="#D65CD6" secondaryColour="#BD42BD">' +
...
Blockly.Blocks.soundToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_SOUND}" id="sound" colour="#D65CD6" secondaryColour="#BD42BD">' +
'</category>';

Blockly.Blocks.eventsMessageToolbox = '<xml id="toolbox-categories" style="display: none">' +
...
Blockly.Blocks.eventsChangeToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_EVENTS}" id="events" colour="#FFD500" secondaryColour="#CC9900">' +
...
Blockly.Blocks.eventsToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_EVENTS}" id="events" colour="#FFD500" secondaryColour="#CC9900">' +
'</category>';

Blockly.Blocks.controlUtilityToolbox = '<xml id="toolbox-categories" style="display: none">' +
...
Blockly.Blocks.controlConditionalsToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_CONTROL}" id="control" colour="#FFAB19" secondaryColour="#CF8B17">' +
...
Blockly.Blocks.controlToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_CONTROL}" id="control" colour="#FFAB19" secondaryColour="#CF8B17">' +
'</category>';

Blockly.Blocks.sensingValueToolbox = '<xml id="toolbox-categories" style="display: none">' +
...
Blockly.Blocks.sensingUtilityToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_SENSING}" id="sensing" colour="#4CBFE6" secondaryColour="#2E8EB8">' +
...
Blockly.Blocks.sensingToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_SENSING}" id="sensing" colour="#4CBFE6" secondaryColour="#2E8EB8">' +
'</category>';

Blockly.Blocks.operatorsLogicToolbox = '<xml id="toolbox-categories" style="display: none">' +
...
Blockly.Blocks.operatorsCalculateToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_OPERATORS}" id="operators" colour="#40BF4A" secondaryColour="#389438">' +
...
Blockly.Blocks.operatorsToolbox = '<xml id="toolbox-categories" style="display: none">' +
'<category name="%{BKY_CATEGORY_OPERATORS}" id="operators" colour="#40BF4A" secondaryColour="#389438">' +
'</category>';
